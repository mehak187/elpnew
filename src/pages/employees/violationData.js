...
export const initialViolations = [
  ...
  {
    // Decided and deducted: what it took comes off September's pay.
    id: 2,
    violationNo: "VIO-002",
    employee: "Priya Sharma",
    type: "Attendance",
    date: "2026-09-02",
    description: "Left the front desk unattended without arranging cover.",
    documentName: "",
    investigationStart: "2026-09-03",
    investigationStatus: "Completed",
    investigator: "Ahmed Al Balushi",
    response: "Acknowledged, and apologised to the office.",
    responseDocument: "",
    investigationResult: "Violation Confirmed",
    penaltyType: DEDUCTION_PENALTY,
    deductionAmount: 25,
    decisionReasons: "A first deduction, at the lowest step.",
    decisionDocument: "",
    penaltyDate: "2026-09-10",
    approvedBy: "Mohammed Al Yahyaei",
